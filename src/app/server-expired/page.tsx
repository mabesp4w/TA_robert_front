        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-500 to-orange-500 p-8 text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-4xl font-bold mb-2">Server Expired</h1>
              <p className="text-red-100 text-lg">
                Masa aktif server telah berakhir
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-amber-700">
                    Harap segera lakukan perpanjangan server untuk mengaktifkan
                    kembali website Anda. Jika sudah melakukan pembayaran,
                    tunggu beberapa saat hingga status server terupdate.
                  </p>
                </div>
              </div>
            </div>
